...
# THIS IS FOR ISO 527 TEST REPORTS ONLY!

import os
import pandas as pd
import csv
import shutil
from ISO_527_google import login, upload
data_source = "C:/Python Projects/Filament Testing/Tensile Data/ISO 527/"
xls_destination = "C:/Python Projects/Filament Testing/Old Tensile Data/Excel/ISO 527/"
csv_destination = "C:/Python Projects/Filament Testing/Old Tensile Data/CSV/ISO 527/"
output = "C:/Python Projects/Filament Testing/ISO527.csv"
